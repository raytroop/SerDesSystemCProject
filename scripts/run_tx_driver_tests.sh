...
# run_tx_tests.sh
# Script to run all TX Driver module unit tests independently
#
...
TEST_NAMES=(
    "test_tx_driver_dc_gain"
    "test_tx_driver_common_mode"
    "test_tx_driver_soft_saturation"
    "test_tx_driver_hard_saturation"
    "test_tx_driver_bandwidth"
    "test_tx_driver_psrr_test"
    "test_tx_driver_gain_mismatch"
    "test_tx_driver_slew_rate"
)
...
echo ""
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  TX Driver Module Unit Tests${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
