/**
 * @file test_adaption_dfe_sign_lms.cpp
 * @brief Unit test for AdaptionDe - DFE Algorithm Sign-LMS
 */
...
TEST(AdaptionDfeTest, DfeSignLms) {
    ...
    // Verify all taps are within range
