/**
 * @file test_sampler_output_range_neg05.cpp
 * @brief Unit test for RxSamplerTdf module - Output Range with -0.5V input
 */
...
TEST(SamplerValidationTest, OutputRangeNeg05) {
