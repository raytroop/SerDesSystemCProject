/**
 * @file test_clock_gen_freq_10ghz.cpp
 * @brief Unit test for ClockGenerationTdf module - 10GHz Frequency Configuration
 */
...
TEST(ClockGenerationFrequencyTest, Frequency10GHz) {
