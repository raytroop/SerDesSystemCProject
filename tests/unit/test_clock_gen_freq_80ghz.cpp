/**
 * @file test_clock_gen_freq_80ghz.cpp
 * @brief Unit test for ClockGenerationTdf module - 80GHz Frequency Configuration
 */
...
TEST(ClockGenerationFrequencyTest, Frequency80GHz) {
    (void)time_resolution_set;  // Ensure static initializer runs
    
    double freq = 80e9;  // 80 GHz
